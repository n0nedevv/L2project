...
public final class PlayerBuffer extends Folk {
	...
	public void onAction(Player player, boolean isCtrlPressed, boolean isShiftPressed)
	{
		...
		else
		{
			...
			//	player.getAI().tryToInteract(this, false, false);
			//else
			//{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (actualCommand.equalsIgnoreCase("restore"))
		{
			...
			if (summon != null)
				summon.getStatus().setHpMp(summon.getStatus().getMaxHp(), summon.getStatus().getMaxMp());
		...
		else if (actualCommand.equalsIgnoreCase("dobuff"))
		{
			...
			{
				if (player.getInventory().getItemCount(Config.PVOTE_BUFF_ITEM_ID) >= 1)
				{
			...
			if (votebuff != null)
			{
				if (player.getInventory().getItemCount(Config.PVOTE_BUFF_ITEM_ID) >= Config.PVOTE_BUFF_ITEM_COUNT)
				{
